...
실행 방법:
  ...
  python examples/generate_figma_editable_v4_batch.py --start 2 --end 5

  # 모든 행 자동 탐색 (제품 코드가 있는 행만)
  python examples/generate_figma_editable_v4_batch.py --all

  # 특정 행들만 지정 (쉼표로 구분)
  python examples/generate_figma_editable_v4_batch.py --rows 2,5,10
...
spec = importlib.util.spec_from_file_location(
    "generate_figma_editable_v4",
    project_root / "examples" / "generate_figma_editable_v4.py"
)
